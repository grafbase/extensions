    ...
    fn from(value: DatabaseType<'_>) -> Self {
        match value {
            DatabaseType::Scalar(scalar) => match scalar.kind {
                ...
                ScalarKind::Decimal => PgType::String,
                ScalarKind::Numeric => PgType::String,
                ...
                ScalarKind::Timestamp => PgType::Int64,
                ScalarKind::Timestamptz => PgType::String,
                ScalarKind::Date => PgType::String,
                ScalarKind::Time => PgType::String,
                ScalarKind::Timetz => PgType::String,
                ...
                ScalarKind::Cidr => PgType::String,
                ScalarKind::Inet => PgType::String,
                ScalarKind::Macaddr => PgType::String,
                ScalarKind::Macaddr8 => PgType::String,
                ScalarKind::Bit => PgType::String,
                ScalarKind::BitVarying => PgType::String,
                ScalarKind::Varbit => PgType::String,
                ScalarKind::Tsvector => PgType::String,
                ScalarKind::Tsquery => PgType::String,
                ScalarKind::Uuid => PgType::String,
                ScalarKind::Xml => PgType::String,
                ScalarKind::Json => PgType::String,
                ScalarKind::Jsonb => PgType::String,
...
impl ScalarType {
    ...
    pub fn client_type(self) -> Option<&'static str> {
        ...
        let type_name = match self.kind {
            Bigint | Char | Text | Xml | Cidr | Macaddr8 | Macaddr | Varchar | Bit | Varbit => "String",
            Bigserial | Date | Inet | Time | Timetz => "String",
            Uuid => "String",
            Timestamp => "String",
            Timestamptz => "String",
            Interval => "String",
...
impl From<u32> for ScalarType {
    fn from(value: u32) -> Self {
        let (kind, is_array) = match value {
            ...
            790 => (ScalarKind::Numeric, false), // Money
            791 => (ScalarKind::Numeric, true),  // Money array
