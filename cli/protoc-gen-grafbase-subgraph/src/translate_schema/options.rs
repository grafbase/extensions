//! This module must be kept in sync with options.proto.

pub(super) const OBJECT_DIRECTIVES: u32 = 58301;
...
pub(super) const DERIVE_FIELD: u32 = 58304;
pub(super) const KEY: u32 = 58305;
pub(super) const JOIN_FIELD: u32 = 58306;
